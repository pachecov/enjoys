...
function sp_custom_footer() { 
	...
	<div class="site-footer"><div class="wrap"><p>&copy; <?php echo date("Y");?>&nbsp;<?php echo $foot_copyright;?></p></div></div>
...
function partners_loop($atts) {

	extract(shortcode_atts(array(
		"the_query" => ''
	), $atts));
	$partners = get_field('show_logos','option') ? get_field('show_logos','option') : '';
	ob_start();
    if($partners != ''):
        ?>
        <div class="section--partners__our--partners__items">
        <?php
        foreach($partners as $logo):
            $logo_image = $logo['logo_image'] ? $logo['logo_image'] : '';
            $logo_link = $logo['logo_link'] ? $logo['logo_link'] : '';
?>

            <div class="section--partners__our--partners__items__logo">
            <?php if($logo_link != ''):?>
                <img src="<?php echo $logo_image['url']?>" alt="<?php echo $logo_image['alt']?>">
            <?php else: ?>
                <a href="<?php $logo_link ?>" title="<?php echo $logo_image['alt']?>"><img src="<?php echo $logo_image['url']?>" alt="<?php echo $logo_image['alt']?>"></a>
            <?php endif; ?>   
            </div>    
...
add_shortcode('partners', 'partners_loop');